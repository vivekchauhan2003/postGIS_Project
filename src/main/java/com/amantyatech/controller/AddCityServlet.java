...
//            String sql = "INSERT INTO cities (name, location) VALUES (?, ST_SetSRID(ST_MakePoint(?, ?), 4326))";
//            PreparedStatement ps = conn.prepareStatement(sql);
//            ps.setString(1, name);
//            ps.setDouble(2, lon);
//            ps.setDouble(3, lat);
//            ps.executeUpdate();
//            res.getWriter().write("City added!");
...
//            String insertSql = "INSERT INTO cities (name, location) VALUES (?, ST_SetSRID(ST_MakePoint(?, ?), 4326))";
...
//            ps.executeUpdate();
//
//            // ✅ Step 3: Reset sequence to max ID
